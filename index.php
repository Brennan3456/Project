			...
			<div id="mercuryContainer" class='fade planet' style="background-color:black;">
				...
				<div class='TextOuterDiv'>
					<div class='TextInnerDiv'>
						...
						<div class="Content">
							Mercury is the closest planet to the sun and in turn, circles the the sun faster than any other planet.<br /><br />
							It's called Mercury after the Roman messenger God.<br /><br />
							The planets surface can reach up to 450 degrees Celsius, however, it has no atmosphere to trap any heat 
							and during the night the temperature plummets to 170 degrees Celsius.<br /><br />
							Mercury is the smallest planet in our solar system, as well as being slightly bigger than earths moon.
							<br />
						</div>
						
						<div class="Title"> Significant Information </div>
						<div class="Content">
							...
							it left a crater big enough to fit the entire state of Texas.<br /><br />
							...
							Mercury is also the second densest planet due to its huge metallic core.
							<br />
						</div>
						...
						<div class="Content">
							...
							It’s still in the planning stages, but ESA and JAXA intend to build a spacecraft that can split into two portions: a planetary orbiter and a magnetospheric orbiter
							<br />
						</div>
					</div>
				</div>  
